...
(setq doom-font (font-spec :family "jetBrains Mono SemiBold" :size 13 :weight 'semi-bold))
...
(map! "<f1>" 'treemacs)
(map! "<f2>" 'treemacs-select-window)
(map! "<f3>" 'eshell)
(map! "<f4>" 'lsp-describe-thing-at-point)
(map! "<f5>" 'treemacs-switch-workspace)
